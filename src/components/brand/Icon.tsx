const PATHS: Record<string, string> = {
  ...
  palette:
    "M12 3a9 9 0 1 0 0 18c1.1 0 2-.9 2-2 0-.5-.2-1-.5-1.3-.3-.4-.5-.8-.5-1.3 0-1.1.9-2 2-2h2a4 4 0 0 0 4-4c0-4.4-4-7.4-9-7.4Z M7.5 13a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Zm2-4.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Zm5 0a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Zm2 4.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z",
  image:
