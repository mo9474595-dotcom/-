...
import GradeClient from "@/app/teacher/(app)/exams/[examId]/results/[attemptId]/GradeClient";
...
export default async function AssistantAttemptDetailPage({
  params,
}: {
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        <h1 className="text-2xl font-bold text-brand-navy-dark">{attempt.studentName}</h1>
